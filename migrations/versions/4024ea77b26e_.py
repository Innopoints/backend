...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "lifetime_stage",
            sa.Enum("draft", "ongoing", "past", name="lifetimestage"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "feedback_questions", sa.ARRAY(sa.String(length=1024)), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("approved", "pending", "rejected", name="applicationstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "(product_id IS NULL)::INTEGER + (project_id IS NULL)::INTEGER + (activity_id IS NULL)::INTEGER < 1",
