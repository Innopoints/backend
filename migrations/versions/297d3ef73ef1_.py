...
def upgrade():
    ...
    op.execute("CREATE TYPE notificationtype AS enum('purchase_status_changed', 'new_arrivals', 'claim_innopoints', 'application_status_changed', 'service', 'manual_transaction', 'project_review_status_changed', 'all_feedback_in', 'out_of_stock', 'new_purchase', 'project_review_requested', 'added_as_moderator');")
