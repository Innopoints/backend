...
Revision ID: 000f7c1b8862
Revises: 
Create Date: 2019-11-11 15:01:23.886571
...
def upgrade():
    ...
    sa.Column('lifetime_stage', sa.Enum('draft', 'created', 'finished', name='lifetimestage'), nullable=False),
    sa.ForeignKeyConstraint(['creator_id'], ['accounts.email'], ),
    ...
    sa.ForeignKeyConstraint(['account_id'], ['accounts.email'], ),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('applicant_id', sa.String(length=128), nullable=False),
    sa.Column('activity_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['activity_id'], ['activities.id'], ),
    sa.ForeignKeyConstraint(['applicant_id'], ['accounts.email'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
    sa.ForeignKeyConstraint(['recipient_id'], ['accounts.email'], ),
    sa.PrimaryKeyConstraint('id')
    )
